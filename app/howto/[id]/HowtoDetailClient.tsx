...
export default function HowtoDetailClient({ id, initialHowto }: { id: string; initialHowto: any }) {
  ...
  const structuredData = {
    ...
    "datePublished": howto.createdAt || new Date().toISOString(),
    "dateModified": howto.createdAt || new Date().toISOString(),
    "author": {
      "@type": "Organization",
      "name": "메이플 아이템"
    },
    ...
    "description": howto.content.replace(/<[^>]+>/g, '').slice(0, 160),
    "articleSection": howto.category,
    ...(howto.imageUrl && {
